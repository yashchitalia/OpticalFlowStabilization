...
{
    cvNamedWindow("Example2",CV_WINDOW_AUTOSIZE);
    g_capture=cvCreateFileCapture("/Users/yashchitalia/Desktop/OpenCV_trial/OpenCV_trial/duder_orig.AVI"); // MODIFY THIS!!!
    int frames=(int)cvGetCaptureProperty(g_capture,CV_CAP_PROP_FRAME_COUNT);
    ...
    matlabFile.open("/Users/yashchitalia/Desktop/OpenCV_trial/OpenCV_trial/pointsOutput_raw.txt");// MODIFY THIS!!!
    ...
    {   //matlabFile << "Corners = [ ...\n";//Starting the file
        ...
        */
        ...
        sprintf(filename, "/Users/yashchitalia/Desktop/OpenCV_trial/OpenCV_trial/duder_raw/VideoFrame%d.jpg", PosFrames);//MODIFY THIS!!!
